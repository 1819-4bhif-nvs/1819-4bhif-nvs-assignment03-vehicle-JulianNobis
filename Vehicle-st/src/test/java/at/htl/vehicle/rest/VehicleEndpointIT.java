...
public class VehicleEndpointIT {
    ...
    public void initClient(){
        ...
        this.target = client.target("http://localhost:8181/vehicle/rs/vehicle");
    }
    ...
    public void crud(){
        ...
        Response deleteResponse = this.target
                ...
                .request(MediaType.APPLICATION_JSON)
                .delete();
        assertThat(deleteResponse.getStatus(), is(204)); // no content if error code = 405 --> method not allowed) --> solution: start wildfly first!!
    }
